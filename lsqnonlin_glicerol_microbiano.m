clear; clc;
a0 = [0.50  ,0.50  ,0.100,1e-6, 9e-3 ,10];
lb = [0.10  ,0.10  ,0.600,1e-5, 9e-2 ,10 ];
ub = [0.90  ,0.90  ,1.000,1e-4, 9e-1 ,10 ];
...
function fv = sistemaNL(a,v,vcell)
    ...
    M=0.02; %quantidade de microorganismos no início (segundo artigo,0) mol/m³
