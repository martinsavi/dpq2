clear; clc;
a0 = [0.2,  0.2,2 , 0.05,1.5e-2, 45, 3.6e-6, 100]; % alfa a,alfa c, ecell, kk, rcell, ilim, Dglicerol
lb = [0.1 ,0.10,2 ,0.05, 1.5e-2, 45,  3.6e-6, 0];
ub = [0.5 ,0.50,2 ,2,    1.5e-2, 45,   3.6e-6, 100];
